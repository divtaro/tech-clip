...
export default function LoginPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-950 dark:to-slate-900 p-4">
      <Card className="w-full max-w-md shadow-xl border bg-white dark:bg-slate-900">
        ...
        <CardContent className="space-y-6 pt-2 pb-8">
          <Button
            ...
            className="w-full h-12 text-base font-medium shadow-md hover:shadow-lg transition-all cursor-pointer"
            size="lg"
          >
          ...
          <div className="text-center">
            <p className="text-xs text-muted-foreground">
              ログインすることで、<a href="#" className="underline hover:text-foreground transition-colors">利用規約</a>と
              <a href="#" className="underline hover:text-foreground transition-colors">プライバシーポリシー</a>に同意したものとみなされます
            </p>
          </div>
        </CardContent>
      </Card>
